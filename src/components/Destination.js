        ...
        <div className="text-destination">
          ...
          {nbPlanet === 0 ? (
            <div>
              ...
              <div className="stat-planet">
                <div className="distance">Avg. distance 384,400 km</div>
                <div className="travel-time">Est. travel time 3 days</div>
              </div>
            </div>
          ) : null}
          ...
          {nbPlanet === 1 ? (
            <div>
              ...
              <div className="stat-planet">
                <div className="distance">Avg. distance 225 mil. km</div>
                <div className="travel-time">Est. travel time 9 months</div>
              </div>
            </div>
          ) : null}
          ...
          {nbPlanet === 2 ? (
            <div>
              ...
              <div className="stat-planet">
                <div className="distance">Avg. distance 628 mil. km</div>
                <div className="travel-time">Est. travel time 3 years</div>
              </div>
            </div>
          ) : null}
          ...
          {nbPlanet === 3 ? (
            <div>
              ...
              <div className="stat-planet">
                <div className="distance"> Avg. distance 1.6 bil. km</div>
                <div className="travel-time">Est. travel time 7 years</div>
              </div>
            </div>
          ) : null}
        </div>
